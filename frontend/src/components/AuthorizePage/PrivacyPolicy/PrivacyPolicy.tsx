        ...
        <div className={"PrivacyPolicyPage"}>
            <div className={"PrivacyPolicyInner"}>
                ...
                <div className={"PrivacyPolicyPageText"}>
                    ...
                    <br></br>
                    <p className={"bold"}>Wof&uuml;r nutzen wir Ihre Daten?</p> 
                    <p>Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gew&auml;hrleisten. Andere Daten k&ouml;nnen zur Analyse Ihres Nutzerverhaltens verwendet werden.</p> 
                    <br></br>
                    <p className={"bold"}>Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?</p> 
                    ...
                    <br></br>
                    <p className={"bold"}>Wir setzen folgenden Hoster ein:</p>
                    <br></br>
                    <p>Salesforce (Heroku)<br />
                    ...
                    <br></br>
                    <p className={"bold"}>Die verantwortliche Stelle f&uuml;r die Datenverarbeitung auf dieser Website ist:</p> 
                    <br></br>
                    <p>Jakob Panten<br />
                    Hasselwerderstra&szlig;e 37<br />
                    12439 Berlin</p>
                    <p>E-Mail: hi@s-potify.fun</p>
                    <br></br>
