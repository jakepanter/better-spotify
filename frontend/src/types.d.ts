...
// Definitions: https://github.com/Definitelyexport typed/Definitelyexport typed
// export typeScript Version: 2.2

// Release comments:
// -----------------

// The audio analysis object is not yet in the Object Model at Spotify, therefore it is export typed as any in this file.
...
declare module "spotify-types" {
     ...
     *
     * `q` and `export type` are required in the API. Previous versions of the export type declarations marked them
     * as optional in order for external libraries to "implement them as function call parameters instead".
     * Now, the export type declaration shall mark them as required. If necessary, one can consider this to be a
     * "breaking change". In that case, one can use export typeScript's built-in utility export type `Omit<T, K>`.
     * For example, one can remove the `q` and `export type` by annotating the export type
     * as `Omit<SpotifyApi.SearchForItemParameterObject, "q" | "export type">`.
     */
     export interface SearchForItemParameterObject {
      ...
      q: string;
      /**
       * A comma-separated list of item export types to search across. Valid export types are: `album`, `artist`, `playlist`, and `track`.
       * Search results include hits from all the specified item export types.
       * For example: `q=name:abacab&export type=album,track` returns both albums and tracks with `“abacab”` included in their name.
       */
      type: string;
      /**
   ...
   * 
   * At the time of typing, the Audio Analysis Object is absent from the Object Model, so it is export typed as any.
   ...
   * Search for an album
   * 
   * GET /v1/search?export type=album
   ...
   * 
   * GET /v1/search?export type=artist
   * https://developer.spotify.com/web-api/search-item/
   */
   ...
   * 
   * GET /v1/search?export type=playlist
   * https://developer.spotify.com/web-api/search-item/
   */
   ...
   * Search for a track
   * 
   * GET /v1/search?export type=track
   * https://developer.spotify.com/web-api/search-item/
   */
   ...
   * Search for a show
   * 
   * GET /v1/search?export type=show
   * https://developer.spotify.com/web-api/search-item/
   */
   ...
   * 
   * GET /v1/search?export type=episode
   * https://developer.spotify.com/web-api/search-item/
   */
   ...
   * https://developer.spotify.com/web-api/search-item/
   */
  export interface SearchResponse extends Partial<ArtistSearchResponse>, Partial<AlbumSearchResponse>, Partial<TrackSearchResponse>, Partial<PlaylistSearchResponse>, Partial<ShowSearchResponse>, Partial<EpisodeSearchResponse> {}
   ...
   *
   * Note that there might be other export types available, it couldn't be found in the docs.
   */
   ...
   * but needs to be made since the tracks export types vary in the Full and Simplified versions.
   */
  ...
  export interface ShowObjectSimplified extends ContextObject {
      ...
      languages: string[];
      /**
       * The media export type of the show.
       */
      media_type: string;
      /**
